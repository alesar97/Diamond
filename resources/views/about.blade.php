...
@section('body')
    ...
    <style>
        ...
        .main-timeline4 .description{font-size:17px;color:#6f6f6f;margin:0 0 5px}
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2 class="text-center"> {{__('navbar.about')}}</h2>
</br>
</br>
</br>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-timeline4 animate" data-animation="scaleAppear">
                                    <div class="timeline">
                                        <a class="timeline-content">
                                            <span class="year">2015</span>
                                            <div class="inner-content">
                                                <h3 class="title">{{__('about.title1')}}</h3>
                                                <p class="description">
                                                    {{__('about.details1')}}
                                                </p>
                                            </div>
                                    ...
                                    <div class="timeline">
                                        <a class="timeline-content">
                                            ...
                                            <div class="inner-content">
                                                <h3 class="title"> {{__('about.title2')}}</h3>
                                                <p class="description">
                                                    {{__('about.details2')}}
                                                </p>
                                            </div>
                                    ...
                                    <div class="timeline">
                                        <a class="timeline-content">
                                            ...
                                            <div class="inner-content">
                                                <h3 class="title">{{__('about.title3')}}</h3>
                                                <p class="description">
                                                    {{__('about.details3')}}
                                                </p>
                                            </div>
                                    ...
                                    <div class="timeline">
                                        <a class="timeline-content">
                                            ...
                                            <div class="inner-content">
                                                <h3 class="title">{{__('about.title4')}}</h3>
                                                <p class="description">
                                                    {{__('about.details4')}}
                                                </p>
                                            </div>
