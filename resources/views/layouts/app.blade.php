                            ...
                            <div class="top-includes main-includes">
                                ...
                                <div class="widget course-dropdown">
                                    <button type="button" class="login-btn-form login_modal_window" id="course-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="fs-17 fa fa-user-circle" aria-hidden="true"></i>&nbsp {{__('navbar.profile')}}
                                    </button>
                            ...
                            <div class="intro_layers">
                                ...
                                <form role="search" method="get" class="search-form search-course animate" action="http://webdesign-finder.com/" data-animation="fadeInUp">
                                    <div class="form-group has-placeholder">
                                        ...
                                        <button type="submit" class="search-submit btn btn-maincolor">{{__('navbar.search')}} </button>
                                    </div>
                                </form>
